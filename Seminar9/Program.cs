...
// int num = Convert.ToInt32(Console.ReadLine());  // 4

// int firstNum = 1;

// string PrintNumber(int start, int end)  //4, 1
// {
//     if(start==end)
//     {
...
//     return start+ " "+ PrintNumber(start+1, end); //1_2_3_4
// }
...
//     return (num * SumNumber(num, rank-1)); // 5* 5* 5  (5, 3)
// }
